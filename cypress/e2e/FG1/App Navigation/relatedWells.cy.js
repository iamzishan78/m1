    ...
    it('Passes', () => {
          ...
          cy.verifyApiResponse('@getESSimpleSearchApi', { responseTimeout: longTimeout }).then(response => {
              ...
              cy.getTableCell('Agreement', 1).then(($cell) => {
                  ...
                  cy.get("#addRelatedWellBtn", { timeout: longTimeout }).scrollIntoView().click({ force: true })
                  ...
                  cy.verifyApiResponse('@AddShapeWellInterestApi', { responseTimeout: extraTimeout }).then(response => {
                      ...
                      cy.verifyApiResponse('@getESPaginatedListApi', { responseTimeout: longTimeout }).then(response => {
                          ...
                          cy.get("#deleteWellInterest", { timeout: longTimeout }).scrollIntoView().click({force:true})
                          cy.get("#deleteButton", { timeout: longTimeout }).scrollIntoView().click({force:true})
