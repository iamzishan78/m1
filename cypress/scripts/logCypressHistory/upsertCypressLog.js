...
const { BUILD_ID, SOURCE_BRANCH, PIPELINE_RUN_MODE } = getPipelineData();

const UpsertCypressLog = async ({ pr, specs, buildId = BUILD_ID, pipelineRunMode = PIPELINE_RUN_MODE, isFailedRetry = false}) => {
  try {
