...
describe('AgreementFieldsSection', () => {
    ...
    cy.viewport(1600, 1200).mount(
      <Summary
        agreementDetails={{
          ...
          "shape": "{\"id\":\"65dacc1a03f30ec669391fbf\",\"type\":\"Feature\",\"geometry\":{\"coordinates\":[[[-98.58057784757655,34.874191788354324],[-98.21063646483867,34.874191788354324],[-98.21063646483867,34.62418612847762],[-98.58057784757655,34.62418612847762],[-98.58057784757655,34.874191788354324]]],\"type\":\"Polygon\"},\"properties\":{\"shapeSubtitle\":\"\",\"type\":\"agreement\",\"layerType\":\"agreement\",\"layerSubType\":\"contract\",\"shapeLabel\":\"NIC-ASIA-405 AGREEMENT\",\"agreementName\":\"405 AGREEMENT\",\"agreementType\":\"contract\",\"shapeArea\":\"232,699.73\",\"shapeCenter\":[-98.3956071562076,34.74918895841597],\"id\":\"65dacc1a03f30ec669391fbf\",\"agreementNumber\":\"NIC-ASIA\",\"name\":\"NIC-ASIA-405 AGREEMENT\",\"netRoyalityAcres\":null,\"acquisitionID\":\"\",\"agreementStatus\":\"ON HOLD\",\"agreementSubtype\":\"tester 123\",\"rightsType\":\"tester 345\",\"prospectID\":\"44433899\",\"internalCompany\":\"test\"},\"name\":\"NIC-ASIA-405 AGREEMENT\",\"layer\":{\"id\":\"contract\"}}",
  ...
  it('checks agreement detail page auto-completes are working', () => {
    ...
    cy.get('body').click();
    cy.get('#field-prospectID').click().type("cypress test value");
    ...
    cy.get('body').click();
    cy.get('#field-acquisitionID').click().type("cypress test value");
    cy.get('.MuiAutocomplete-option').first().click();
    cy.get('body').click();
    ...
    cy.get('body').click();
    cy.get('#field-internalCompany').click().type("cypress test value");
    cy.get('.MuiAutocomplete-option').first().click();
    cy.get('body').click();
