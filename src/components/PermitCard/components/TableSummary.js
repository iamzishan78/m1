				...
				<Table aria-label="simple table" className={classes.table} loading={!summary}>
					<TableBody>
						<TableRow className={classes.tableRow}>
							...
							<TableCell className={classes.rowCell}>{summary.Play}</TableCell>
							<TableCell scope="row" className={classes.rowName}>
								Basin
							</TableCell>
						...
						<TableRow className={classes.tableRow}>
							...
							<TableCell className={classes.rowCell}>{summary.CurrentOperator}</TableCell>
							<TableCell scope="row" className={classes.rowName}>
								Formation
							</TableCell>
						...
						<TableRow className={classes.tableRow}>
							...
							<TableCell className={classes.rowCell}>{summary.OriginalOperator}</TableCell>
							<TableCell scope="row" className={classes.rowName}>
								Permit Number
							</TableCell>
