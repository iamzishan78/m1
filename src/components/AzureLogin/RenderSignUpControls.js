...
const BuyersSvg = props => {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" width="120" height="120" overflow="hidden" viewBox="0 0 508 508">
			<defs>
				<filter id="c" width="129.3%" height="140.8%" filterUnits="objectBoundingBox">
			...
			<path
				...
				filter="url(#c)"
			></path>
			<path fill="#011133" strokeWidth="1" d="M233.5 98.3H348.2V114.69999999999999H233.5z" filter="url(#c)"></path>
			<path fill="#011133" strokeWidth="1" d="M233.5 155.7H348.2V172.1H233.5z" filter="url(#c)"></path>
			<path fill="#011133" strokeWidth="1" d="M233.5 213H348.2V229.4H233.5z" filter="url(#c)"></path>
			<path
				fill="#011133"
				strokeWidth="1"
				...
				filter="url(#c)"
			></path>
			<path fill="#011133" strokeWidth="1" d="M102.4 327.7H290.9V344.09999999999997H102.4z" filter="url(#c)"></path>
			<path fill="#011133" strokeWidth="1" d="M102.4 426.1H217.10000000000002V442.5H102.4z" filter="url(#c)"></path>
			<path
				fill="#011133"
				strokeWidth="1"
...
const OperatorSvg = props => {
	return (
		...
		>
			<defs>
				<filter id="b" width="109.3%" height="110.8%" filterUnits="objectBoundingBox">
...
const SellersSvg = props => {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" width="144" height="123" viewBox="0 0 144 123">
			<defs>
				<filter id="a" width="109.3%" height="110.8%" x="-4.6%" y="-5.4%" filterUnits="objectBoundingBox">
