	...
	const renderSignupNewCard = signUpUserType ? (
		<div style={{ marginBottom: '170px' }}>
			...
			<div className={localClass.cardContainer}>
				...
				<Card elevation={0} square={true} color="secondary" className={localClass.signUpSupportCard}>
					<div>
						<Typography
							style={{
								marginTop: '75px',
					...
					<div>
						...
						>
							Streamline your business process from deal sourcing to offer management to due-diligence with a built for
							purpose workflow solution.
						</Typography>
					</div>
					<div>
						<Typography
						...
						>
							We are here and ready to answer any questions you have along the way.
						</Typography>
					</div>
            ...
            >
              Terms and Conditions
						...
						<div className={localClass.links}>
							...
							<Link to="/" style={{ marginLeft: '10px' }} className={localClass.link}>
								{' '}
								Sign In
							</Link>
						</div>
