			...
			>
				<div className={classes.paper}>
					...
					<div className={classes.containerContent}>
						<M1neralIconSvg />
						<h2 className={classes.header} id="server-modal-title">
							Thank You For The Interest And Will Be In Touch.
						</h2>
						...
						<p className={classes.news} id="server-modal-description">
							...
							<a className={classes.aTag} rel="noopener noreferrer" target="_blank" href="https://www.m1neral.com/">
								latest
							</a>
							news.
						</p>
