...
const ForgotPassword = props => {
	...
	const renderScreens = !resetPasswordBool ? (
		<Card color="secondary" style={{ backgroundColor: 'rgba(38, 52, 81, 1)' }} className={classes.card}>
			...
			<div className={classes.cardInputs}>
				...
				/>
				<Button variant="outlined" disableElevation className={classes.button} onClick={resetPassword}>
					SUBMIT
				</Button>
			</div>
		</Card>
	...
	return <div className={classes.myRoot}>{renderScreens}</div>;
};
