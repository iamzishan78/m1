...
const Login = props => {
  ...
  const renderBody = !showSignUp ? (
    ...
    <div>
      <Typography variant="h4" className={classes.headerWords}>
        Welcome back!
      </Typography>
      </div>
      ...
      <Card color="secondary" className={localClass.card}></Card>
      </div>
      
      <div>
      <Typography  className={classes.headerWords}>
        Don't have an account? 
      </Typography>
      <Typography  className={classes.smallerWords}>
        Get started today
      </Typography>
    </div>
