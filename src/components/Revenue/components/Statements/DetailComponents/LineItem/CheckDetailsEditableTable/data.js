export const RevenueStatementHeadCells = [
    ...
    {
        id: "interestType", title: "Interest Type", filterKey: 'interestType.keyword', sort: true, type: 'autocomplete', esIndex: 'checkdetails_flat', width: '200px'
    },
    {
        id: "price", title: "Avg Price", filterKey: 'price', sort: true, width: '100px'
    },
    {
        id: "grossPropertyVolume", title: "Prop Gross Volume", filterKey: 'grossPropertyVolume', sort: true, width: '150px'
    },
    {
        id: "grossPropertyValue", title: "Prop Gross Revenue", filterKey: 'grossPropertyValue', sort: true, width: '150px'
    },
    {
        id: "grossOwnerVolume", title: "Owner Volume", filterKey: 'grossOwnerVolume', sort: true, width: '150px'
    },
    {
        id: "grossOwnerValue", title: "Owner Gross Revenue", filterKey: 'grossOwnerValue', sort: true, width: '150px'
    },
    {
        id: "ownerTax", title: "Owner Tax Amt", filterKey: 'ownerTax', sort: true, width: '150px'
    },
    {
        id: "taxType", title: "Tax Type", filterKey: 'taxType.keyword', sort: true, type: 'autocomplete', esIndex: 'checkdetails_flat', width: '225px'
    },
    {
        id: "ownerDeducts", title: "Deduct Amount", filterKey: 'ownerDeducts', sort: true, width: '150px'
    },
    {
        id: "deductType", title: "Deduct Type", filterKey: 'deductType.keyword', sort: true, type: 'autocomplete', esIndex: 'checkdetails_flat', width: '225px'
    },
    {
