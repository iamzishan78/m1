...
const Filter = ({ status, onClick }) => {
	...
	return (
		<IconButton className={[classes.filterButton, 'filterButton', (status && 'active') || '']} onClick={onClick}>
				...
				<Card variant="outlined" className={classes.card}>
					<CardContent className={classes.cardContent}>
						<Typography variant="h6" component="div" className={classes.cardHeaderTypography}>
							Approved
							<Filter
								status={filtersState['approved']}
								onClick={() => {
									handleFilterActions('approved');
								}}
							/>
						</Typography>
						<Typography variant="h6" component="div" className={classes.cardNumberTypography}>
				...
				<Card variant="outlined" className={classes.card}>
					<CardContent className={classes.cardContent}>
						<Typography variant="h6" component="div" className={classes.cardHeaderTypography}>
							Needs Approval
							<Filter
								status={filtersState['unapproved']}
								onClick={() => {
									handleFilterActions('unapproved');
								}}
							/>
						</Typography>
						<Typography
				...
				<Card variant="outlined" className={classes.card}>
					<CardContent className={classes.cardContent}>
						<Typography variant="h6" component="div" className={classes.cardHeaderTypography}>
							Potential Issues
							<Filter
								status={filtersState['potentialIssues']}
								onClick={() => {
									handleFilterActions('potentialIssues');
								}}
							/>
						</Typography>
