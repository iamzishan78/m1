      ...
      <div style={{ flexShrink: 0 }}>
        ...
        >
          {new RegExp(["jpg", "jpeg", "png", "bmp"].join("|")).test(fileUpload?.fileExtension) ? (
            <img src={fileUpload?.fileInformation?.uri} alt={fileUpload?.fileInformation?.name} className={classes.forImage}></img>
          ) : (
            <div
              className={fileUpload?.fileExtension ? classes.forImageContainer : ''}
              onClick={() => {
