      ...
      updateContact({
        variables: {
          contact: {
            ...
            contactStatus: ownerToAdd.contactStatus.value || ownerToAdd.contactStatus,
            status: ownerToAdd.status.value || ownerToAdd.status,
            lastUpdateBy: getUser?._id,
            ownerType: ownerToAdd.ownerType.value || ownerToAdd.ownerType,
            campaignPriority: ownerToAdd.campaignPriority.value || ownerToAdd.campaignPriority,
          },
        },
      });
    }
          ...
          shapeOwners: [
            {
              _id: selectedRow?._id,
              ...formStateValues,
              contactStatus: formStateValues.contactStatus.value || formStateValues.contactStatus,
              status: formStateValues.status.value || formStateValues.status,
              ownerType: formStateValues.ownerType.value || formStateValues.ownerType,
              campaignPriority: formStateValues.campaignPriority.value || formStateValues.campaignPriority,
