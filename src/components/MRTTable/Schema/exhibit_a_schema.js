...
const ExhibitAMeta = {
	...
	TableSchema: [
		...
		},
		{
			...CommonSchema.HIDDEN,
			header: 'Agreement Id',
			accessorFn: row => row?.original?.shape._id,
			id: 'shape._id',
			name: 'shape._id',
		},
		{
			...
			header: 'Agreement #',
			accessorFn: row => row?.original?.shape?.shapeJson?.properties?.agreementNumber,
		...
		},
		{
			...
			accessorFn: row => row?.original?.shape?.shapeJson?.properties?.agreementName,
		...
		},
		{
			...CommonSchema.COMMON_COLUMN,
			header: 'Type',
			accessorFn: row => row?.original?.shape?.shapeJson?.properties?.agreementType,
		...
		},
		{
			...
			accessorFn: row => row?.original?.shape?.shapeJson?.properties?.grantor,
		...
		},
		{
			...
			accessorFn: row => row?.original?.shape?.shapeJson?.properties?.grantee,
		...
		},
		{
			...CommonSchema.COMMON_COLUMN,
			header: 'Agmt Date',
			accessorFn: row => row?.original?.shape?.shapeJson?.properties?.agreementDate,
		...
		},
		{
			...CommonSchema.COMMON_COLUMN,
			header: 'Efftv Date',
			accessorFn: row => row?.original?.shape?.shapeJson?.properties?.effectiveDate,
		...
		},
		{
			...
			accessorFn: row => row?.original?.shape?.shapeJson?.properties?.agreementStatus,
		...
		},
		{
			...CommonSchema.COMMON_COLUMN,
			header: 'Tract Name',
			accessorFn: row => row?.original?.parcel.name,
			id: 'parcel.name',
		...
		},
		{
			...CommonSchema.COMMON_COLUMN,
			header: 'State',
			accessorFn: row => row?.original?.parcel?.shapeJson?.properties?.originalProperties?.State,
		...
		},
		{
			...CommonSchema.COMMON_COLUMN,
			header: 'County',
			accessorFn: row => row?.original?.parcel?.shapeJson?.properties?.originalProperties?.County,
		...
		},
		{
			...
			accessorFn: row => row?.original?.shape?.shapeJson?.properties?.legalDesctiption,
		...
		},
		{
			...
			accessorFn: row => row?.original?.shape?.shapeJson?.properties?.internalCompany,
		...
		},
		{
			...CommonSchema.COMMON_COLUMN,
			header: 'Prospect',
			accessorFn: row => row?.original?.shape?.shapeJson?.properties?.prospectID,
		...
		},
		{
			...CommonSchema.COMMON_COLUMN,
			header: 'Acquisition',
			accessorFn: row => row?.original?.shape?.shapeJson?.properties?.acquisitionID,
		...
		},
		{
			...CommonSchema.COMMON_COLUMN,
			header: 'Rec Date',
			accessorFn: row => row?.original?.shape?.shapeJson?.properties?.recordedDate,
		...
		},
		{
			...CommonSchema.COMMON_COLUMN,
			header: 'Book',
			accessorFn: row => row?.original?.shape?.shapeJson?.properties?.recordedBook,
		...
		},
		{
			...CommonSchema.COMMON_COLUMN,
			header: 'Page',
			accessorFn: row => row?.original?.shape?.shapeJson?.properties?.recordedPage,
		...
		},
		{
			...CommonSchema.COMMON_COLUMN,
			header: 'Instrument #',
			accessorFn: row => row?.original?.shape?.shapeJson?.properties?.recordedInstrumentNumber,
