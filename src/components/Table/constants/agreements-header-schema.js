...
const AgreementsHeadCells = [
    ...
    {
        name: "agreementNumber", label: "Agreement #", esKey: 'shapeJson.properties.agreementNumber.keyword', 
        options: { 
    ...
    {
        name: "agreementName", label: "Agreement Name", esKey: 'shapeJson.properties.agreementName.keyword', 
        options: { 
    ...
    {
        name: "agreementType", label: "Type", esKey: 'shapeJson.properties.agreementType.keyword', 
        options: { 
    ...
    {
        name: "agreementSubtype", label: "Subtype", esKey: 'shapeJson.properties.agreementSubtype.keyword', 
        options: { 
            dbName: "shapeJson.properties.agreementSubtype",
            sort: true, 
            filter: true 
    ...
    {
        name: "agreementDate", label: "Agmt Date", esKey: 'shapeJson.properties.agreementDate.keyword', 
        options: { 
    ...
    {
        name: "agreementStatus", label: "Status", esKey: 'shapeJson.properties.agreementStatus.keyword', 
        options: { 
