...
function ContactTaxRollInterestTable(props) {
	...
	const [getContactTaxRollInterests, { data: dataContactTaxRollInterst }] = useLazyQuery(
		GET_CONTACT_TAX_ROLL_INTERESTS_QUERY,
		{
	...
	const [updateWellInterest] = useMutation(UPDATEWELLINTEREST, {
		refetchQueries: ['getContactWells', 'getPaginatedContactWellInterests'],
