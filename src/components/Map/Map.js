...
export default function Map() {
  ...
  const setLayer = (data, layerName, map) => {
    ...
    if (config) {
      ...
      const clusterVar = config.layerProps.layerId + "-clusters";
      const clusterLabelBar = config.layerProps.layerId + "-clusters-counts";
