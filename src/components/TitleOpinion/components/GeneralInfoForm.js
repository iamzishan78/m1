...
export default function GeneralInfoForm() {
	...
	return (
		<form className={`${classes.root} ${classes.GIWrapper}`} noValidate autoComplete="off">
			<Grid container className={classes.maxWidth} spacing={1}>
				<Grid container item xs={12} spacing={2}>
					...
					<Grid item xs={4} className={classes.logoGrid} style={{ textAlign: 'center' }}>
						<img
					...
					<Grid item xs={4}>
						<Autocomplete
							...
							renderInput={params => <TextField {...params} label="State" variant="outlined" fullWidth />}
						/>
					</Grid>
