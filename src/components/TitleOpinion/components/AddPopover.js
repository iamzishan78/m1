...
export default function SimplePopover(props) {
	...
	return (
		<div>
			<IconButton aria-label="settings" onClick={handleClick} className={classes.iconAdd}>
			...
			>
				<Button className={classes.btn} aria-describedby={id} variant="contained" color="primary" onClick={addRow}>
					New Row
				</Button>
				<br />
