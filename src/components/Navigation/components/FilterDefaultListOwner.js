												...
												<Chip
													...
													label={
														<section>
															...
															<div className={classes.chipRow}>{removeNameFromTypeInterest(elm[1][1][1])}</div>
														</section>
													}
											...
											elm[1][2] ? (
												<Chip
													...
													label={
														<section>
															<div className={classes.chip}>Interest Type</div>
															<div className={classes.chipRow}>{removeNameFromTypeInterest(elm[1][2][1])}</div>
														</section>
													}
											...
											elm[1][3] ? (
												<Chip
													...
													label={
														<section>
															<div className={classes.chip}>Interest Type</div>
															<div className={classes.chipRow}>{removeNameFromTypeInterest(elm[1][3][1])}</div>
														</section>
													}
											...
											elm[1][4] ? (
												<Chip
													...
													label={
														<section>
															<div className={classes.chip}>Interest Type</div>
															<div className={classes.chipRow}>{removeNameFromTypeInterest(elm[1][4][1])}</div>
														</section>
													}
									...
									? filtersTypeArr.map(v =>
											v[0] === 'filterOwnerCount' && v[1][1] ? (
												<Chip
													...
													label={
														<section>
															<div className={classes.chip}>{removeNameFromType(v[1][1][0])}</div>
															<div className={classes.chipRow}>{v[1][1][2]}</div>
														</section>
													}
									...
									? filtersTypeArr.map(c =>
											c[0] === 'filterOwnerCount' && c[1][2] ? (
												<Chip
													...
													label={
														<section>
															<div className={classes.chip}>{removeNameFromType(c[1][2][0])}</div>
															<div className={classes.chipRow}>{c[1][2][2]}</div>
														</section>
													}
												...
												<Chip
													...
													label={
														<section>
															...
															<div className={classes.chipRow}>{removeNameFromType(a[1][1][1])}</div>
														</section>
													}
											...
											o[0] === 'filterAllOwnershipTypes' && o[1][2] ? (
												<Chip
													...
													label={
														<section>
															<div className={classes.chip}>Owner Type</div>
															<div className={classes.chipRow}>{removeNameFromType(o[1][2][1])}</div>
														</section>
													}
											...
											l[0] === 'filterAllOwnershipTypes' && l[1][3] ? (
												<Chip
													...
													label={
														<section>
															<div className={classes.chip}>Owner Type</div>
															<div className={classes.chipRow}>{removeNameFromType(l[1][3][1])}</div>
														</section>
													}
											...
											m[0] === 'filterAllOwnershipTypes' && m[1][4] ? (
												<Chip
													...
													label={
														<section>
															<div className={classes.chip}>Owner Type</div>
															<div className={classes.chipRow}>{removeNameFromType(m[1][4][1])}</div>
														</section>
													}
											...
											el[0] === 'filterAllOwnershipTypes' && el[1][5] ? (
												<Chip
													...
													label={
														<section>
															<div className={classes.chip}>Owner Type</div>
															<div className={classes.chipRow}>{removeNameFromType(el[1][5][1])}</div>
														</section>
													}
											...
											em[0] === 'filterAllOwnershipTypes' && em[1][6] ? (
												<Chip
													...
													label={
														<section>
															<div className={classes.chip}>Owner Type</div>
															<div className={classes.chipRow}>{removeNameFromType(em[1][6][1])}</div>
														</section>
													}
											...
											elment[0] === 'filterAllOwnershipTypes' && elment[1][7] ? (
												<Chip
													...
													label={
														<section>
															<div className={classes.chip}>Owner Type</div>
															<div className={classes.chipRow}>{removeNameFromType(elment[1][7][1])}</div>
														</section>
													}
											...
											e[0] === 'filterAllOwnershipTypes' && e[1][8] ? (
												<Chip
													...
													label={
														<section>
															<div className={classes.chip}>Owner Type</div>
															<div className={classes.chipRow}>{removeNameFromType(e[1][8][1])}</div>
														</section>
													}
