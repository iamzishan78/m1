									...
									? filtersTypeArrSCSA.map(ele =>
											ele[1][1] && ele[1][1].length === 5 ? (
												<Chip
													...
													label={
														<section>
															<div className={classes.chip}>{removeNameFromType(ele[1][1][1][1])}</div>
															<div className={classes.chipRow}>{ele[1][1][2]}</div>
														</section>
													}
									...
									? filtersTypeArrSCSA.map(elem =>
											elem[1][2] && elem[1][2].length === 5 ? (
												<Chip
													...
													label={
														<section>
															<div className={classes.chip}>{removeNameFromType(elem[1][2][1][1])}</div>
															<div className={classes.chipRow}>{elem[1][2][2]}</div>
														</section>
													}
									...
									? filtersTypeArrSCSA.map(elemt =>
											elemt[1][3] && elemt[1][3].length === 5 ? (
												<Chip
													...
													label={
														<section>
															<div className={classes.chip}>{removeNameFromType(elemt[1][3][1][1])}</div>
															<div className={classes.chipRow}>{elemt[1][3][2]}</div>
														</section>
													}
