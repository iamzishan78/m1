...
function ContactFormModal(props) {
	...
	return (
		<Dialog aria-labelledby="simple-dialog-title" open={open} onClose={onClose} className={classes.root}>
			...
			<DialogContent>
				<DialogContentText className={classes.dialogContentText}>How can we help you today?</DialogContentText>
				<TextField
					variant="outlined"
					autoFocus
					id="name"
				...
				<FormControl variant="outlined" fullWidth className={classes.inputField} size="small" error={errors.category}>
