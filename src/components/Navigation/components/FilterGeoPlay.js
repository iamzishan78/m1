...
export default function FilterPlay() {
  ...
  const [playName, setPlayName] = React.useState(stateNav.playName ? stateNav.playName : null);
  ...
  return (
    <Autocomplete
      ...
      value={stateNav.playName}
      onChange={(event, newValue) => {
        handlePlayChange(newValue);
      }}
      multiple
      options={playList}
      renderInput={(params) => <TextField {...params} variant="outlined" label="Play" placeholder="" fullWidth={true} />}
      disableListWrap
    />
  );
}
