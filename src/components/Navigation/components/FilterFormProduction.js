...
const listOptions = [
  ...
  { name: "First Three Months  -  Oil", filterName: "filterFirstThreeMonthOil", id: "firstThreeMonthOil", display: false },
  { name: "First Three Months  -  Gas", filterName: "filterFirstThreeMonthGas", id: "firstThreeMonthGas", display: false },
  { name: "First Three Months  -  Water", filterName: "filterFirstThreeMonthWater", id: "firstThreeMonthWater", display: false},
  { name: "First Six Months  -  Oil", filterName: "filterFirstSixMonthOil", id: "firstSixMonthOil", display: false },
  { name: "First Six Months  -  Gas", filterName: "filterFirstSixMonthGas", id: "firstSixMonthGas", display: false },
  { name: "First Six Months  -  Water", filterName: "filterFirstSixMonthWater", id: "firstSixMonthWater", display: false },
  { name: "First Twelve Months  -  Oil", filterName: "filterFirstTwelveMonthOil", id: "firstTwelveMonthOil", display: false },
  { name: "First Twelve Months  -  Gas", filterName: "filterFirstTwelveMonthGas", id: "firstTwelveMonthGas", display: false },
  { name: "First Twelve Months  -  Water", filterName: "filterFirstTwelveMonthWater", id: "firstTwelveMonthWater", display: false },
