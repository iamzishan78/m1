									...
									<Grid item sm={12}>
										<FormControl style={{ width: '100%' }}>
											<FormGroup>
												...
												/>
												<Typography variant="caption" style={{ color: '#8c8c8c', paddingLeft: '32px' }} gutterBottom>
													Distributed every Wednesday, this email provides a comprehensive overview of the previous week
													on the marketplace as well as highlights of important events.
												</Typography>
											</FormGroup>
										</FormControl>
									</Grid>
