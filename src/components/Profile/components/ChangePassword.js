									...
									<Grid item sm={6}>
										<Grid container spacing={0} style={{ flex: 1, flexDirection: 'column' }}>
											...
											<Grid item sm={8} style={{ paddingTop: 10 }}>
												<Button
													variant="contained"
													style={{ width: '100%', backgroundColor: '#25b1e1', color: '#fff' }}
													disableElevation
												>
													Update Password
												</Button>
										...
										<Grid container spacing={2} style={{ flex: 1, flexDirection: 'column', margin: 10 }}>
											<Grid item sm={12}>
												<Typography component="div">
													<Box fontWeight="bold">Password Requirements</Box>
												</Typography>
											</Grid>
											<Grid item sm={12}>
												<Typography component="div" style={{ display: 'inline-flex' }}>
													<CheckCircleIcon style={{ color: '#12b906', marginRight: 5 }} />
													<Box fontWeight="fontWeightLight">Minimum of 8 character</Box>
												</Typography>
											</Grid>
											<Grid item sm={12}>
												<Typography component="div" style={{ display: 'inline-flex' }}>
													<CheckCircleIcon style={{ color: '#12b906', marginRight: 5 }} />
													<Box fontWeight="fontWeightLight">An UPPERCASE letter</Box>
												</Typography>
											</Grid>
											<Grid item sm={12}>
												<Typography component="div" style={{ display: 'inline-flex' }}>
													<CheckCircleIcon style={{ color: '#12b906', marginRight: 5 }} />
													<Box fontWeight="fontWeightLight">A lowercase letter</Box>
												</Typography>
											</Grid>
											<Grid item sm={12}>
												<Typography component="div" style={{ display: 'inline-flex' }}>
													<CheckCircleIcon style={{ color: '#12b906', marginRight: 5 }} />
													<Box fontWeight="fontWeightLight">A number</Box>
												</Typography>
											</Grid>
											<Grid item sm={12}>
												<Typography component="div" style={{ display: 'inline-flex' }}>
													<CheckCircleIcon style={{ marginRight: 5 }} />
													<Box fontWeight="fontWeightLight">A Symbol</Box>
												</Typography>
											</Grid>
										</Grid>
									</Grid>
