...
const InvestingPreferences = () => {
	...
	const basin = ['US', 'Midwest', 'Northeast', 'Nortwest', 'Southeast', 'Soutwest', 'Southern', 'Western'];
	const vehicles = ['Funds', 'Properties'];
	const hold_period = ['Less than 1 year', '1-2 Years', '3-5 Years', '6-9 Years', '10+ Years'];
	const objectives = ['Aggressive', 'Growth'];
														...
														<FormControlLabel
															...
															control={
																<Checkbox
																	...
																	checked={
																		typeof state.investingPreferences.InvestingInterests !== 'undefined' &&
												...
												<FormControl variant="outlined" className={classes.formControl}>
													...
													<div style={{ display: 'inline-flex' }}>
														<Select
															...
															style={{ width: '100%' }}
															value={
																typeof stateProfile.investingPreferences !== 'undefined' &&
																typeof stateProfile.investingPreferences.InvestingObjectives !== 'undefined' &&
																typeof stateProfile.investingPreferences.InvestingObjectives
																	.expected_total_in_12_months !== 'undefined'
																	? stateProfile.investingPreferences.InvestingObjectives.expected_total_in_12_months
																	: 'undecided'
															}
													...
													<div style={{ display: 'inline-flex' }}>
														<Select
															...
															value={
																typeof stateProfile.investingPreferences !== 'undefined' &&
																typeof stateProfile.investingPreferences.InvestingObjectives !== 'undefined' &&
																typeof stateProfile.investingPreferences.InvestingObjectives.risk_tolerance !==
																	'undefined'
																	? stateProfile.investingPreferences.InvestingObjectives.risk_tolerance
																	: 'undecided'
															}
													...
													<div style={{ display: 'inline-flex' }}>
														<Select
															...
															value={
																typeof stateProfile.investingPreferences !== 'undefined' &&
																typeof stateProfile.investingPreferences.InvestingObjectives !== 'undefined' &&
																typeof stateProfile.investingPreferences.InvestingObjectives.expected_per_project !==
																	'undefined'
																	? stateProfile.investingPreferences.InvestingObjectives.expected_per_project
																	: 'undecided'
															}
