											...
											<FormControl variant="outlined" className={classes.formControl} style={{ paddingTop: 10 }}>
												...
												>
													{industry_list.map((item, index) => {
														return (
															<option key={`industry_${index}`} value={index}>
																{item}
															</option>
														);
													})}
											...
											<Grid item sm={4}>
												<FormControl style={{ width: '100%', padding: 10 }}>
													...
													<RadioGroup
														...
														value={state.isAccreditedInvestor}
														row
													>
														...
														<FormControlLabel
															...
															control={
																<Checkbox
																	...
																	checked={
																		state.investingExperience !== null && state.investingExperience.includes(item)
																	}
																/>
															}
															label={item}
												...
												<FormControlLabel
													control={
														<Checkbox
															...
															checked={
																state.emailNotifications !== null && state.emailNotifications.includes('newsletter')
															}
														/>
													}
												...
												<FormControlLabel
													control={
														<Checkbox
															...
															onChange={e => dispatch({ type: 'emailNotifications', value: e.target.value })}
															checked={
																state.emailNotifications !== null && state.emailNotifications.includes('marketlease')
															}
														/>
													}
												...
												<FormControlLabel
													control={
														<Checkbox
															...
															onChange={e => dispatch({ type: 'emailNotifications', value: e.target.value })}
															checked={
																state.emailNotifications !== null && state.emailNotifications.includes('relevantissue')
															}
														/>
													}
