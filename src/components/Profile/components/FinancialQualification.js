				...
				<Grid container spacing={2} className={classes.root}>
					<Grid item sm={12} style={{ backgroundColor: '#f9f9f9' }}>
						<Typography component="div">
							<Box fontWeight="bold">
								SEC 506(d) You must certify that you are an accredited investor. Choose which of the following options
								apply to you. You may check more than one: *
							</Box>
						</Typography>
					</Grid>
					<Grid item sm={12}>
						<FormControl style={{ width: '100%' }}>
							<FormGroup>
								<FormControlLabel
									...
									label={
										'I alone, or in combination with my spouse, have net worth of $1,000,000. Net worth for this purpose means the fair market' +
								...
								/>
								<Typography variant="caption" style={{ color: '#8c8c8c', paddingLeft: '32px' }} gutterBottom>
									Distributed every Wednesday, this email provides a comprehensive overview of the previous week on the
									marketplace as well as highlights of important events.
								</Typography>
							</FormGroup>
						</FormControl>
					</Grid>
						...
						<FormControl style={{ width: '100%' }}>
							<FormGroup>
								<FormControlLabel
									control={<Checkbox key="1" color="primary" name="new_offerings" />}
									label={
										'I am / My company engaged in the business of exploring for or producing oil or gas or other minerals as an ongoing business.'
									}
									labelPlacement="end"
								/>
							</FormGroup>
					...
					<Grid item sm={12} style={{ backgroundColor: '#f9f9f9' }}>
						<Typography component="div">
							<Box fontWeight="bold">
								The following financial detail is required. Please use your personal information if you are registering
								as an individual or your business income if you are registering as a business representative
							</Box>
						</Typography>
					</Grid>
					<Grid item sm={12}>
