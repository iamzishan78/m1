...
const ProfileDetails = () => {
	...
	const {
		fields: { fullname, profileImage, email },
		isSaving,
	} = stateProfile;
				...
				<Grid container className={newStyle.root}>
									...
									badgeContent={
										<label htmlFor="profile-image">
											<Tooltip title={`Upload a photo`} arrow placement="bottom-end">
												<AddAPhotoIcon className={newStyle.editIcon} />
											</Tooltip>
										</label>
									}
								>
					...
					<Grid item sm={10}>
						<Grid container className={newStyle.contentSubroot}>
							<Grid item sm={12}>
								<ProfileHeader handleSubmit={handleSubmit} isSaving={isSaving} handleClose={handleClose} />
							</Grid>
							<Grid
								item
								sm={12}
