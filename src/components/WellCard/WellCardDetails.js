  ...
  return stateApp.selectedWell ? (
    <Card className={classes.card}>
      ...
      <CardHeader
        ...
        action={
          <div className = {classes.icons}>
            ...
            <IconButton color="secondary" onClick={handleCloseDetails} aria-label="shrink">
              <ShrinkIcon viewBox="0 0 64 64"  fontSize="small" />
            </IconButton>
          </div>
        }
        title={stateApp.selectedWell.wellName ? stateApp.selectedWell.wellName : '--'}
        subheader={
      ...
      <Grid className={classes.grid}  container spacing={1}>
        ...
        <Grid item xs={12}>
          <OwnersProvider selectedWell={stateApp.selectedWell} parent="well"/>
        </Grid>
      </Grid>
