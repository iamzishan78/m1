...
const WellCardContextProvider = React.memo(props => {
	...
	return (
		<WellCardContext.Provider value={[stateWellCard, setStateWellCard]}>{props.children}</WellCardContext.Provider>
	);
});

WellCardContext.whyDidYouRender = true;
WellCardContextProvider.whyDidYouRender = true;
