						...
						<CardContent className={classes.content}>
							...
							<div>
								...
								{wellData?.State === 'CO' ? (
									<Link
										href={
											'https://cogcc.state.co.us/cogisdb/Facility/FacilityDetail?api=' +
											wellData?.ApiNumber.substring(2)
										}
										onClick={() => {}}
										variant="body2"
								...
								{wellData?.State === 'KS' ? (
									<Link
										href={
											'https://chasm.kgs.ku.edu/ords/qualified.well_page.DisplayWell?f_kid=' + wellData?.StateWellId
										}
										onClick={() => {}}
										variant="body2"
										target="_blank"
