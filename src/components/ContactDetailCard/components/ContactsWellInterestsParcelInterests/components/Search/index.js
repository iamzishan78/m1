              ...
              <Grid container direction="column" spacing={1}>
                <Grid item>
                  <Typography className={classes.heading}>
                    2. Select the interests to associate to the contact from the list below
                  </Typography>
                </Grid>
                <Grid item md={12}>
                  <MUIDataTable
                      ...
                      customToolbarSelect: () => (
                        <div style={{ height: "48px", display: "flex" }}>
                          <div style={{ marginTop: "6px", height: "35px", display: "flex", marginRight: "20px" }}>
                            <Button color="secondary" className={classes.multiSelectionTopBarButtons} onClick={addWellInterestToContact}>
                              {" "}
                              + Add to contact
                            </Button>
                          </div>
