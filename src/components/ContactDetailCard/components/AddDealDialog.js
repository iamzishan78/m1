        ...
        Recent Activities
            ...
            <div className={classes.inputFieldDateRoot}>
              <TextField
                ...
                required
                error={valid["title"]}
                helperText={valid["title"] ? "Enter a deal name to get started" : ""}
                fullWidth
                //   required
                onChange={(e) => {
              ...
              <FormControl variant="outlined" fullWidth size="small" className={classes.inputField}>
              ...
              <FormControl variant="outlined" fullWidth className={classes.inputField} size="small">
              ...
              <FormControl variant="outlined" fullWidth className={classes.inputField} size="small">
                <Autocomplete
                  ...
                  renderInput={(params) => (
                    <TextField margin="dense" {...params} variant="outlined" label="Deal Owner" InputLabelProps={{ shrink: true }} />
                  )}
                />
              </FormControl>
