...
const eportData = { CONTACTS, TRACTS, UNITS, PARCELINTERESTS, SHAPEOWNER, CHECKDETAILS, PROPERTIES, CONTACTS_WELL_INTEREST, AGREEMENT_SHAPE, AGREEMENT_HEADER, AGREEMENT_COMMENTS, CONTACT_COMMENTS, TRACT_COMMENTS }
