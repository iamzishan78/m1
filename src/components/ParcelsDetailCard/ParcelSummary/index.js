...
export default function ParcelSummary(props) {
	...
	const tableData = React.useMemo(() => {
		...
		props.properties.execNetAcres = props.properties?.execNetAcres
			? addTrailingZeros(parseFloat(props.properties.execNetAcres).toFixed(8))
			: 0;
		props.properties.nonExecNetAcres = props.properties?.nonExecNetAcres
			? addTrailingZeros(parseFloat(props.properties.nonExecNetAcres).toFixed(8))
			: 0;
