...
function DialogContent(props) {
  ...
  if (name === 'Home') return (
    ...
    if (consts && functions) {
      ...
      return <Contacts stateAppKey={stateAppKey} gotoContact={gotoContact} getRemoveDescriptorResponse={getRemoveDescriptorResponse} addSelectedContact={addSelectedContact} loading={loading} getData={refetchData} />;
    }
  }
  else if (Component) {
    return <Component />
