...
const AutoCompleteTypeSimpleFilter = ({ onChange, value, shapeType, typeKey, onBlur, ...other }) => {
    ...
    const getFilterPayload = {
        variables: {
            esIndex: "shapes_flat",
            index: "shapes_flat",
            filters: [{ field: "layer.keyword", value: "parcel" }],
            filterKey: "shapeJson.properties.shapeArea.keyword",
            search: { query: "", fields: ["*"] },
            extendSearchQuery: "",
            size: 50,
            filterAggs: { query: "", field: "shapeJson.properties.shapeArea.keyword", size: 50 }
        }
    }
...
AutoCompleteTypeSimpleFilter.defaultProps = {
    autoFocus: true,
};

export default AutoCompleteTypeSimpleFilter;
