...
export const customLayersFieldAccessors = {
	...
	Parcels: {
		keys: [
			...
			{ label: 'Basin', value: 'shapeJson.properties.basin.keyword' },
			{ label: 'Field', value: 'shapeJson.properties.field.keyword' },
		],
		layerKey: 'Parcel',
	},
	Agreements: {
	...
	Wells: {
		keys: [
			...
			{ label: 'TVD [ft.]', value: 'trueVerticalDepth', type: 'range' },
			{ label: 'MD [ft.]', value: 'measuredDepth', type: 'range' },
			{ label: 'Lateral [ft.]', value: 'lateralLength', type: 'range' },
			{ label: 'Permit Approved Date', value: 'permitApprovedDate', type: 'date' },
			{ label: 'Spud Date', value: 'spudDate', type: 'date' },
