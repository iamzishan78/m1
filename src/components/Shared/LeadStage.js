...
const Step = ({ name, active, onClick, last }) => {
	...
	return (
		<div className={`${classes.step} ${active ? classes.activeStep : classes.inActiveStep}`} onClick={onClick}>
...
export default function LeadStage({ leadStage, id }) {
	...
	const leadStages = ['New', 'Contacted', 'Interested', 'Follow-up', 'Offer Sent', 'Closed'];
