...
export default function WellTypeCard(props) {
	...
	const WellTypeIcon = () => {
		if (summary.WellType && summary.WellType.toUpperCase() == 'OIL') {
			return <OilDropIcon fontSize="large" />;
		} else if (summary.WellType && summary.WellType.toUpperCase() == 'GAS') {
			return <GasFlameIcon fontSize="large" />;
		} else if (summary.WellType && summary.WellType.toUpperCase() == 'OIL AND GAS') {
			return <OilGasIcon fontSize="large" />;
		} else if (summary.WellType && summary.WellType.toUpperCase() == 'INJECTION') {
			return <WaterDropIcon fontSize="large" />;
		} else if (summary.WellType && summary.WellType.toUpperCase() == 'WATER') {
			return <WaterDropIcon fontSize="large" />;
		} else if (summary.WellType && summary.WellType.toUpperCase() == 'P&A') {
			...
			{summary && (
				<div className={classes.iconContainer}>
					...
					<Typography align="center" variant="caption">
						{summary.WellType ? summary.WellType.toUpperCase() : '--'}
					</Typography>
				</div>
			)}
		</div>
