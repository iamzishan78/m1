	...
	return parcelData ? (
		<Grid container className={classes.gridWidthScroll} spacing={0}>
			<Grid item container sm={12}>
				...
				<Grid item sm={7} className={`${classes.borderRight} ${classes.qtrAndInputs}`}>
					<Grid container spacing={2}>
						<Grid item xs={12} style={{ display: 'flex' }}>
							...
							<div style={{ width: 'Calc( 100% - 273px)' }}>
								...
								<TextField size="small" value={parcelData.name} variant="outlined" fullWidth />
								<p className="formLabel">Gross Acres</p>
								<TextField size="small" value={parcelData.grossAcres} variant="outlined" fullWidth />
