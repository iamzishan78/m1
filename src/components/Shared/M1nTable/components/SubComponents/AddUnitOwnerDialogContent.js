                  ...
                  render={(props) => (
                    <TextField
                      ...
                      onChange={(e) => {
                        ...
                        if (!isNraOverridden) setValue("nra", calculateStandardNraForUnit(uAcres, e.target.value, getValues().royalty_interest, getValues().orri, workspaceSettings));
                      }}
                      fullWidth
                      defaultValue=""
                    />
                ...
                <Controller
                  ...
                  render={(props) => (
                    <TextField
                      ...
                      onChange={(e) => {
                        props.onChange(e.target.value);
                        if (!isNraOverridden) setValue("nra", calculateStandardNraForUnit(uAcres, getValues().working_interest, e.target.value, getValues().orri, workspaceSettings)
                        );
                      }}
                      fullWidth
                      defaultValue=""
                ...
                <Controller
                  ...
                  render={(props) => (
                    <TextField
                      ...
                      onChange={(e) => {
                        props.onChange(e.target.value);
                        if (!isNraOverridden) { setValue("nra", calculateStandardNraForUnit(uAcres, getValues().working_interest, getValues().royalty_interest, e.target.value, workspaceSettings)); }
                      }}
                      fullWidth
                      defaultValue=""
                    />
                  ...
                  render={(params) => (
                    <TextField
                      ...
                      onChange={(e) => {
                        ...
                        if (!isNraOverridden) {
                          const nra = calculateStandardNraForUnit(uAcres, getValues().working_interest, getValues().royalty_interest, getValues().orri, workspaceSettings)
                            ...
                            {isNraOverridden && (
                              <IconButton
                                ...
                                onClick={() => {
                                  ...
                                  setValue("nra", calculateStandardNraForUnit(uAcres, getValues().working_interest, getValues().royalty_interest, getValues().orri, workspaceSettings));
                                }}
                              >
                                <AutorenewIcon />
                              </IconButton>
