...
const CustomFieldMultiSelect = ({ index, value, onCustomKeyChange, dropdownOptions, column, fullWidth, variant }) => {
					...
					if (option.value === 'editOption') {
						...
						return (
							...
							>
								...
								>
									<Checkbox
										checked={value?.includes(option.value) || (!value && option.value === defaultValue.label)}
										color="default"
										style={{ marginRight: 5 }}
										inputProps={{
