...
function AddAgreementOwnerAndTractDialog(props) {
  ...
  const calculateNetAcres = () => {
    ...
    const netAcres = addTrailingZeros(getValues()?.tract?.sdGrossAcres ? (getValues()?.tract?.sdGrossAcres * getValues().mineral_interest).toFixed(8) : null);
    return netAcres;
  };
        ...
        <div style={{ padding: "30px" }}>
...

          {
            isTractOwner ?
              ...
              />
              :
              <AutocompEntityNamesList variant='outlined' placeholder='Search for owner by name'
                nameAutValue={nameAutValue} setNameAutValue={setNameAutValue}
                InputProps={{
                  startAdornment: (
                    <InputAdornment position="start">
                      <SearchIcon />
          ...
          <Controller
            ...
            render={(
              ...
              <TextField
                ...
                onChange={(e) => { onChange(e.target.value); setValue('net_acres', calculateNetAcres()); }}
              />
          ...
          <Controller as={TextField} control={control} variant="outlined" margin="dense" name='royalty_interest' inputRef={register()} label={"Royalty Interest"}
            ...
            <Grid item xs={6} >
              <Controller
                ...
                render={(
                  ...
                  <AutoCompleteWithNewOption margin="dense" label='Tract Status' InputLabelProps={{ shrink: true }} variant="outlined" options={autoCompleteList} value={value} onChange={(_, value) => { value && onChange(value.name); }} />
                )}
              />
            </Grid>
            <Grid item xs={6} >
