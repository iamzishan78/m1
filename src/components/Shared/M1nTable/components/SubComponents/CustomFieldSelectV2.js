...
const CustomFieldSelectV2 = ({ index, value, onCustomKeyChange, dropdownOptions, column, fullWidth, variant, valueMarginLeft }) => {
  ...
  return (
    ...
    >
      <ButtonBase disableRipple className={classes.button} aria-describedby={id} onClick={(event) => setAnchorEl(event.currentTarget)}>
        <span
