...
export default function WellInterestsTopSumary(props) {
	...
	const selectedOwnerWellIntsSummary = useSelector(({ MapGridCard }) => MapGridCard.selectedOwnerWellIntsSummary);
		...
		<Grid container spacing={0}>
			...
			>
				<Paper elevation={3} className={classes.Paper}>
					...
					>
						Well Interests ({numberWithCommas(selectedOwnerWellIntsSummary.interestsCount)})
					</h2>
					<Grid
						container
						spacing={0}
								...
								>
									<span>
										...
										{selectedOwnerWellIntsSummary.averageValue
											? vf_currency(selectedOwnerWellIntsSummary.averageValue)
											: 'N/A'}
										<br />
									</span>
									<span>
										Max Appraisal Value:{' '}
										{selectedOwnerWellIntsSummary.maxValue ? vf_currency(selectedOwnerWellIntsSummary.maxValue) : 'N/A'}
										<br />
									</span>
									<span>
									...
									<span>
										Number of Counties:{' '}
										{selectedOwnerWellIntsSummary.countyCount ? selectedOwnerWellIntsSummary.countyCount : 'N/A'}
										<br />
									</span>
								</h3>
							</div>
