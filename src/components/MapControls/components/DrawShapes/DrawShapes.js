	...
	return (
		<>
			...
			<div
				...
				style={mapControlsStateValues.mapGridCardActivated ? { bottom: '530px' } : {}}
			>
...
export default function DrawShapes() {
	...
	const showDrawShapePopup =
		(drawStateValues.showDrawShapesPopup && !currentFeature) || drawStateValues.addShape || drawStateValues.reDrawShape;
