...
export default function SpatialDataCardEdit(props) {
	...
	const { sdType, shapeLabel, projectName, sdNotes, sdGrossAcres } = props.selectedFeature.properties;
	...
	const deleteSpatialData = () => {
		if (props.selectedFeature && props.selectedFeature.properties && props.selectedFeature.properties.id) {
			updateCustomLayer({
				variables: {
			...
			<CardActions classes={{ root: classes.cardAction }}>
				...
				<div>
					<FormControl required variant="outlined" className={classes.formControl}>
						...
						<Select value={dataType} onChange={evt => setDataType(evt.target.value)} labelWidth={labelWidth}>
