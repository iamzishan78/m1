...
function ExpandableCard(props) {
	...
	useEffect(() => {
		...
		if (document.getElementById('side-panel-pullout-btn')) document.getElementById(' ').style.display = 'none'; // hide pullout button from the sidebar when details card is opened
		return () => {
