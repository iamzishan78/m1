...
export default function ExpandableCard(props) {
  ...
  const [cardWidthExpanded,setCardWidthExpanded] = useState(props.cardWidthExpanded)
  ...
  const [cardHeightExpanded,setCardHeightExpanded] = useState(props.cardHeightExpanded)
        ...
        <CardHeader classes={{title: classes.title,subheader: classes.subheader}}
          action={
            <div>
              ...
              <IconButton color="secondary" onClick={handleShrink} aria-label="shrink">
