...
import { Grid, Typography, Box, Accordion, AccordionSummary, AccordionDetails, IconButton, TextField } from "@material-ui/core";
      ...
      <div className={classes.root}>
        <Accordion className={classes.accordionRoot} defaultExpanded={true}>
          ...
          <AccordionDetails className={classes.accordionDetails}>
            <Grid container direction="row" justify="flex-start" style={{ padding: "10px 0px", display: "flex", gap: "40px" }}>
